                        ...
                        <tbody>
                            ...
                            while ($user_row = $userResult->fetch_assoc()) {
                                ...
                                if($user_row['user_image'] =="") {
                                    ...
                                    $img_path = $img_path.$user_row['user_image'];
                                }
                                $status = "Active";
                                if ($user_row["user_status"] == 0) {
                                    $status = "Deactive";
                                }
                                ?>
                                <tr>
                                    ...
                                    <td><?php echo $user_row['user_fname'] ;?> <?php echo $user_row['user_lname'] ;?></td>
                                    <td><?php echo $user_row['user_email'] ;?></td>
                                    <td 
                                    <?php if($user_row['user_status'] == 1){ ?> 
                                        class="success"
                                    <?php }elseif($user_row['user_status'] == 0){ ?>
                                        class="danger"
                                    <?php } ?>
                                    >
                                    <?php echo $status; ?>
                                    ...
                                    <td>
                                        ...
                                        &nbsp;
                                        <?php }elseif($user_row['user_status'] == 1){?>
